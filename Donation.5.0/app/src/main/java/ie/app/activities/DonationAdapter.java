...
//        ImageView deleteButton = (ImageView) view.findViewById(R.id.imgDelete);
//        deleteButton.setTag(donation);
////        deleteButton.setOnClickListener((View.OnClickListener) Report);
